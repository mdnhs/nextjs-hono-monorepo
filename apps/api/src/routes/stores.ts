...
import { enforceStoreLimit, enforceProductLimit } from '../middlewares/limits'
...
storesRouter.post('/', authenticate, requirePermission(PERMISSIONS.SELLER_STORES_MANAGE), enforceStoreLimit, (c) => storeController.createStore(c))
...
storesRouter.post('/:storeId/products', authenticate, requirePermission(PERMISSIONS.SELLER_PRODUCTS_MANAGE), requireStoreOwnership, enforceProductLimit, (c) => productController.createProduct(c))
